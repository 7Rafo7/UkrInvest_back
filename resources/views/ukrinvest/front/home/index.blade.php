...
@section('content')
    ...
    <div class="header">
        <div class="section section-1">
            <img src="{{ asset('img/front/equipment.png') }}" alt="">
            <h2>UkrInvest</h2>
        </div>
    ...
    <div class="home-banner" id="home">
        ...
        <div class="section section-3">
            <div class="slider">
                <a class="animated-link" href="#mission"><img class="slider-arrow" src="{{ asset('img/front/slider-arrow.png') }}" alt=""></a>
    ...
    <div class="mission-description" id="mission">
        <div class="sections">
            <div class="section section-1">
                <img src="{{ asset('img/front/sigh.png') }}" alt="">
                <h3>Our Mission</h3>
            </div>
            <div class="section section-2">
        ...
        <div class="section section-2">
            <div class="services-card">
                <div class="card card-1">
                    <img src="{{ asset('img/front/light.png') }}" alt="">
                </div>
            ...
            <div class="services-card">
                <div class="card card-3">
                    <img src="{{ asset('img/front/marks.png') }}" alt="">
                </div>
                <h4>ROAD MARKS</h4>
            </div>
            <div class="services-card">
            ...
            <div class="swiper-container">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="card-item">
                            <div class="card__img">
                                <img src="{{ asset('img/front/gallery-traffic-1.jpg') }}" alt="card-img">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card-item">
                            <div class="card__img">
                                <img src="{{ asset('img/front/gallery-traffic-2.jpg') }}" alt="card-img">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card-item">
                            <div class="card__img">
                                <img src="{{ asset('img/front/gallery-traffic-3.jpg') }}" alt="card-img">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="card-item">
                            <div class="card__img">
                                <img src="{{ asset('img/front/gallery-traffic-4.jpg') }}" alt="card-img">
                            </div>
        ...
        <div class="news-section-3">
            <div class="press">
                <div class="press-card">
                    <div class="card-img">
                        <img src="{{ asset('img/front/road-2.jpg') }}" alt="">
                    </div>
                    ...
                    <div class="card-btn">
                        <img src="{{ asset('img/front/more.png') }}" alt="">
                    </div>
                </div>
                <div class="press-card">
                    <div class="card-img">
                        <img src="{{ asset('img/front/road-1.jpg') }}" alt="">
                    </div>
                    <div class="card-content">
                        <h5>28 May, 2019</h5>
                        <h2>Lorem ipsum.</h2>
